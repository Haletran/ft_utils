...
install_vscode_debugger()
{
    ...
    if [ ! -f ".vscode/launch.json" ]; then
        ...
        wget -O vscode-debugger-utils/launch.json https://raw.githubusercontent.com/Haletran/ft_utils/main/vscode-debugger-utils/launch.json
    else
    ...
    if [ ! -f ".vscode/tasks.json" ]; then
        ...
        wget -O vscode-debugger-utils/tasks.json https://raw.githubusercontent.com/Haletran/ft_utils/main/vscode-debugger-utils/tasks.json
    else
